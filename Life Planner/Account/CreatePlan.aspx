            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCreatePlanNRIC" CssClass="text-danger" ErrorMessage="The 'NRIC' field is required." />
                        <br />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="txtCreatePlanEmail" CssClass="text-danger" Display="Dynamic" ErrorMessage="The 'Email' field is required." />--%>
