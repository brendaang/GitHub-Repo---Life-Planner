<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewMyProfile.aspx.cs" Inherits="Life_Planner.Account.ViewMyProfile" %>
        ...
        <div class="container">
            ...
            <div class="well">
                <fieldset class="form-horizontal">
                    <div class="row">
                        <legend class="col-lg-offset-4 col-lg-3">My Profile</legend>
                    </div>
