<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="primaryStats.aspx.cs" Inherits="Life_Planner.primaryStats" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <div class="container">
          ...
          <div class="container">
            <h2>Primary Statistic
            </h2>

            <div class="col-md-6">
                <h4>Percentage of PSLE Students Eligible for Secondary School</h4>
                <div class="well well-sm">
                <iframe width="520" height="600" src="https://data.gov.sg/dataset/percentage-of-students-eligible-for-express-normal-academic-and-normal-technical/resource/0b65d021-6ed1-407c-a261-2ce220cab582/view/692bc00b-f2d9-4e23-be79-eae480168828" frameborder="0"></iframe>
   <p>
...
<br />Percentages are based on all students, regardless of whether they took their subjects at the Standard or Foundation levels.
            ...
            <div class="col-md-6">
                ...
                <h4>Percentage of P1 Cohort Eligible for Secondary School</h4>
                                <div class="well well-sm">
