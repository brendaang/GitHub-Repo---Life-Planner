<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="viewConsolidatedData.aspx.cs" Inherits="Life_Planner.viewConsolidatedData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <script src="scripts/jquery-1.3.2.min.js" type="text/javascript"></script>

    <h1>Percentage of P1 Cohort Who had at least 5 N-Level passes or 3 O-Level passes</h1>
    <iframe width="600" height="400" src="https://data.gov.sg/dataset/percentage-of-p1-cohort-who-had-at-least-5-n-level-passes-or-3-o-level-passes/resource/ff367fe9-7460-46ee-bb37-61a7dc2a4116/view/439a13bb-f204-4da6-917b-b2ad1a96e8b9"></iframe>

    <h1>Percentage of P1 Cohort that Progressed to Post-Secondary Education
    ...
    <h1>Percentage of PSLE Students Eligible for Secondary School </h1>
